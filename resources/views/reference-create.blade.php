  ...
  <div class="col-md-12">
    <div class="card ">
      <div class="card-header ">
        <h4 class="card-title">Create New Reference Document</h4>
      </div>
      <div class="card-body ">
        {{Form::open(['class'=>'form-horizontal'])}}
          ...
          <div class="row">
            ...
            <div class="col-sm-2">
				...
				<div class="form-group">
					{{Form::text('source_par','',['class'=>'form-control'])}}
				</div>
            </div>
            <div class="col-sm-2">
				{{Form::label('client_pg','Client Page')}}
				<div class="form-group">
					{{Form::text('client_pg','',['class'=>'form-control'])}}
				</div>
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
				...
				<div class="form-group">
					{{Form::text('deliv_id','',['class'=>'form-control'])}}
				</div>
            </div>
          </div>
      	{{Form::submit()}}
